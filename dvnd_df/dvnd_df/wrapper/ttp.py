...
# # localpath = "/home/imcoelho/Rodolfo/dvnd-df/code/dvnd-df/dvnd-df/"
# localpath = "/home/rodolfo/git/dvnd-df/code/dvnd-df/dvnd-df/"
#
...
# 	mylibname = 'ttplib'
# 	# "dvnd/*.cu",
# 	libfiles = ["dvnd/*.cu", "dvnd-df/po/pmv/ProblemInfo.cu", "dvnd-df/po/pmv/Solution.cu", "dvnd-df/po/pmv/BuscaLocal.cu"]
# 	options = ["-std=c++11", "-I {}dvnd-df".format(ttppath)]
