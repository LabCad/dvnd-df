...
with open("dvndGdvnd.csv", 'wb') as novo_csvfile:
	...
	content_folders = ["./n4w1/", "./n4w2/", "./n4w3/", "./n4w4/",
		"./n4w5/", "./n4w6/", "./n4w7/", "./n4w8/",
		"./rvnd_n1w1/", "./rvnd_n2w1/", "./rvnd_n2w2/", "./rvnd_n2w3/", "./rvnd_n2w4/"]
	# content_folders = ["./dvndMog_n4w6h1_4in0_7100sol/", "./dvndSog_n4w6h1_4in0_7100sol/"]
	# content_folders = ["./rvnd_n1w1h1_4in0_7100sol/", "./rvndNoDf_n1w1h1_4in0_7100sol/"]
	for folder_to_look in content_folders:
		print("folder: {}".format(folder_to_look))
