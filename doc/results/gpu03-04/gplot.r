...
#     mychart = removeLegendPrintPoints(mychart, paste("chart/points/n", mac_num, "/time", input_num, ".png", sep=""))
#   }
# }
...
#     mychart = removeLegendPrintPoints(mychart, paste("chart/points/n", mac_num, "/final", input_num, ".png", sep=""))
#   }
# }
...
#     mychart = removeLegendPrintPoints(mychart, paste("chart/points/n", mac_num, "/count", input_num, ".png", sep=""))
#   }
# }
...
#     mychart = removeLegendPrintPoints(mychart, paste("chart/points/n", mac_num, "/imp", input_num, ".png", sep=""))
#   }
# }
...
foreach(mac_num=1:4, .combine=cbind) %dopar% {
  ...
  for (input_num in 0:7) {
    ...
    mychart = mychart + theme(axis.title=element_text(size=25), axis.title.x=element_blank(), axis.ticks.x=element_blank(), legend.title = element_blank())
    mychart = mychart + stat_summary(fun.y=mean, geom="point", shape=20, size=2, color="red", fill="red") + ylab("Tempo(s)")
