...
n4w1dvnd = read.csv(file="n4w1dvnd.csv", head=TRUE, sep=";")
n4w2dvnd = read.csv(file="n4w2dvnd.csv", head=TRUE, sep=";")
n4w3dvnd = read.csv(file="n4w3dvnd.csv", head=TRUE, sep=";")
n4w4dvnd = read.csv(file="n4w4dvnd.csv", head=TRUE, sep=";")
n4w5dvnd = read.csv(file="n4w5dvnd.csv", head=TRUE, sep=";")
n4w6dvnd = read.csv(file="n4w6dvnd.csv", head=TRUE, sep=";")
n4w7dvnd = read.csv(file="n4w7dvnd.csv", head=TRUE, sep=";")
n4w8dvnd = read.csv(file="n4w8dvnd.csv", head=TRUE, sep=";")
n4w9dvnd = read.csv(file="n4w9dvnd.csv", head=TRUE, sep=";")
n4w10dvnd = read.csv(file="n4w10dvnd.csv", head=TRUE, sep=";")
...
in0time = c(in0time, list(n4w1dvnd$in0time, n4w2dvnd$in0time, n4w3dvnd$in0time, n4w4dvnd$in0time, n4w5dvnd$in0time, n4w6dvnd$in0time, n4w7dvnd$in0time, n4w8dvnd$in0time, n4w9dvnd$in0time, n4w10dvnd$in0time))
...
in1time = c(in1time, list(n4w1dvnd$in1time, n4w2dvnd$in1time, n4w3dvnd$in1time, n4w4dvnd$in1time, n4w5dvnd$in1time, n4w6dvnd$in1time, n4w7dvnd$in1time, n4w8dvnd$in1time, n4w9dvnd$in1time, n4w10dvnd$in1time))
...
in2time = c(in2time, list(n4w1dvnd$in2time, n4w2dvnd$in2time, n4w3dvnd$in2time, n4w4dvnd$in2time, n4w5dvnd$in2time, n4w6dvnd$in2time, n4w7dvnd$in2time, n4w8dvnd$in2time, n4w9dvnd$in2time, n4w10dvnd$in2time))
...
in3time = c(in3time, list(n4w1dvnd$in3time, n4w2dvnd$in3time, n4w3dvnd$in3time, n4w4dvnd$in3time, n4w5dvnd$in3time, n4w6dvnd$in3time, n4w7dvnd$in3time, n4w8dvnd$in3time, n4w9dvnd$in3time, n4w10dvnd$in3time))
...
in4time = c(in4time, list(n4w1dvnd$in4time, n4w2dvnd$in4time, n4w3dvnd$in4time, n4w4dvnd$in4time, n4w5dvnd$in4time, n4w6dvnd$in4time, n4w7dvnd$in4time, n4w8dvnd$in4time, n4w9dvnd$in4time, n4w10dvnd$in4time))
...
in5time = c(in5time, list(n4w1dvnd$in5time, n4w2dvnd$in5time, n4w3dvnd$in5time, n4w4dvnd$in5time, n4w5dvnd$in5time, n4w6dvnd$in5time, n4w7dvnd$in5time, n4w8dvnd$in5time, n4w9dvnd$in5time, n4w10dvnd$in5time))
...
in6time = c(in6time, list(n4w1dvnd$in6time, n4w2dvnd$in6time, n4w3dvnd$in6time, n4w4dvnd$in6time, n4w5dvnd$in6time, n4w6dvnd$in6time, n4w7dvnd$in6time, n4w8dvnd$in6time, n4w9dvnd$in6time, n4w10dvnd$in6time))
...
in7time = c(in7time, list(n4w1dvnd$in7time, n4w2dvnd$in7time, n4w3dvnd$in7time, n4w4dvnd$in7time, n4w5dvnd$in7time, n4w6dvnd$in7time, n4w7dvnd$in7time, n4w8dvnd$in7time, n4w9dvnd$in7time, n4w10dvnd$in7time))
...
in0final = c(in0final, list(n4w1dvnd$in0final, n4w2dvnd$in0final, n4w3dvnd$in0final, n4w4dvnd$in0final, n4w5dvnd$in0final, n4w6dvnd$in0final, n4w7dvnd$in0final, n4w8dvnd$in0final, n4w9dvnd$in0final, n4w10dvnd$in0final))
...
in1final = c(in1final, list(n4w1dvnd$in1final, n4w2dvnd$in1final, n4w3dvnd$in1final, n4w4dvnd$in1final, n4w5dvnd$in1final, n4w6dvnd$in1final, n4w7dvnd$in1final, n4w8dvnd$in1final, n4w9dvnd$in1final, n4w10dvnd$in1final))
...
in2final = c(in2final, list(n4w1dvnd$in2final, n4w2dvnd$in2final, n4w3dvnd$in2final, n4w4dvnd$in2final, n4w5dvnd$in2final, n4w6dvnd$in2final, n4w7dvnd$in2final, n4w8dvnd$in2final, n4w9dvnd$in2final, n4w10dvnd$in2final))
...
in3final = c(in3final, list(n4w1dvnd$in3final, n4w2dvnd$in3final, n4w3dvnd$in3final, n4w4dvnd$in3final, n4w5dvnd$in3final, n4w6dvnd$in3final, n4w7dvnd$in3final, n4w8dvnd$in3final, n4w9dvnd$in3final, n4w10dvnd$in3final))
...
in4final = c(in4final, list(n4w1dvnd$in4final, n4w2dvnd$in4final, n4w3dvnd$in4final, n4w4dvnd$in4final, n4w5dvnd$in4final, n4w6dvnd$in4final, n4w7dvnd$in4final, n4w8dvnd$in4final, n4w9dvnd$in4final, n4w10dvnd$in4final))
...
in5final = c(in5final, list(n4w1dvnd$in5final, n4w2dvnd$in5final, n4w3dvnd$in5final, n4w4dvnd$in5final, n4w5dvnd$in5final, n4w6dvnd$in5final, n4w7dvnd$in5final, n4w8dvnd$in5final, n4w9dvnd$in5final, n4w10dvnd$in5final))
...
in6final = c(in6final, list(n4w1dvnd$in6final, n4w2dvnd$in6final, n4w3dvnd$in6final, n4w4dvnd$in6final, n4w5dvnd$in6final, n4w6dvnd$in6final, n4w7dvnd$in6final, n4w8dvnd$in6final, n4w9dvnd$in6final, n4w10dvnd$in6final))
...
in7final = c(in7final, list(n4w1dvnd$in7final, n4w2dvnd$in7final, n4w3dvnd$in7final, n4w4dvnd$in7final, n4w5dvnd$in7final, n4w6dvnd$in7final, n4w7dvnd$in7final, n4w8dvnd$in7final, n4w9dvnd$in7final, n4w10dvnd$in7final))
...
in0count = c(in0count, list(n4w1dvnd$in0count, n4w2dvnd$in0count, n4w3dvnd$in0count, n4w4dvnd$in0count, n4w5dvnd$in0count, n4w6dvnd$in0count, n4w7dvnd$in0count, n4w8dvnd$in0count, n4w9dvnd$in0count, n4w10dvnd$in0count))
...
in1count = c(in1count, list(n4w1dvnd$in1count, n4w2dvnd$in1count, n4w3dvnd$in1count, n4w4dvnd$in1count, n4w5dvnd$in1count, n4w6dvnd$in1count, n4w7dvnd$in1count, n4w8dvnd$in1count, n4w9dvnd$in1count, n4w10dvnd$in1count))
...
in2count = c(in2count, list(n4w1dvnd$in2count, n4w2dvnd$in2count, n4w3dvnd$in2count, n4w4dvnd$in2count, n4w5dvnd$in2count, n4w6dvnd$in2count, n4w7dvnd$in2count, n4w8dvnd$in2count, n4w9dvnd$in2count, n4w10dvnd$in2count))
...
in3count = c(in3count, list(n4w1dvnd$in3count, n4w2dvnd$in3count, n4w3dvnd$in3count, n4w4dvnd$in3count, n4w5dvnd$in3count, n4w6dvnd$in3count, n4w7dvnd$in3count, n4w8dvnd$in3count, n4w9dvnd$in3count, n4w10dvnd$in3count))
...
in4count = c(in4count, list(n4w1dvnd$in4count, n4w2dvnd$in4count, n4w3dvnd$in4count, n4w4dvnd$in4count, n4w5dvnd$in4count, n4w6dvnd$in4count, n4w7dvnd$in4count, n4w8dvnd$in4count, n4w9dvnd$in4count, n4w10dvnd$in4count))
...
in5count = c(in5count, list(n4w1dvnd$in5count, n4w2dvnd$in5count, n4w3dvnd$in5count, n4w4dvnd$in5count, n4w5dvnd$in5count, n4w6dvnd$in5count, n4w7dvnd$in5count, n4w8dvnd$in5count, n4w9dvnd$in5count, n4w10dvnd$in5count))
...
in6count = c(in6count, list(n4w1dvnd$in6count, n4w2dvnd$in6count, n4w3dvnd$in6count, n4w4dvnd$in6count, n4w5dvnd$in6count, n4w6dvnd$in6count, n4w7dvnd$in6count, n4w8dvnd$in6count, n4w9dvnd$in6count, n4w10dvnd$in6count))
...
in7count = c(in7count, list(n4w1dvnd$in7count, n4w2dvnd$in7count, n4w3dvnd$in7count, n4w4dvnd$in7count, n4w5dvnd$in7count, n4w6dvnd$in7count, n4w7dvnd$in7count, n4w8dvnd$in7count, n4w9dvnd$in7count, n4w10dvnd$in7count))
...
labelsTipos = c(labelsTipos, "n4w1", "n4w2", "n4w3", "n4w4", "n4w5", "n4w6", "n4w7", "n4w8", "n4w9", "n4w10")
colorGreen = colorAlpha(c(0, 153.0/255, 0), 10)
colorYellow = colorAlpha(c(1, 1, 0), 10)
colorBlue = colorAlpha(c(0, 0, 102.0/255), 10)
colorPink = colorAlpha(c(204.0/255, 0, 204.0/255), 10)
